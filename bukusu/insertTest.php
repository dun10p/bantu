...
//	$result = pg_execute($dbconn, "", $query_param) or die("<br/>PG_EXEC -> Query failed: ".pg_last_error() . "<br/>");
    ...
    if($result && $table == 'gp.root'){
		header("location:https://babbage.cs.missouri.edu/~cs3380s15grp15/insertWord.php");
	}
	if($result && $table =='gp.words'){
		header("location:https://babbage.cs.missouri.edu/~cs3380s15grp15/insertPhrase.php");
	}
	if($result && $table =='gp.phrasal_data'){
