...
<div id="main">
    ...
    <input type="radio" name="ctrInsert" value="root" onclick="insertClick(this);" />Root Insertion
	<input type="radio" name="ctrInsert" value="word" onclick="insertClick(this);"/>Word Insertion
    <input type="radio" name="ctrInsert" value="phrase" onclick="insertClick(this);" checked/>Phrase Insertion
