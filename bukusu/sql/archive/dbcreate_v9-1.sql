...
-- Table: gp.noun_verb
--Columns:
--	type --values will be noun and verb
DROP TABLE IF EXISTS noun_verb;
CREATE TABLE noun_verb (
	type varchar(24),
	PRIMARY KEY (type)
);
...
DROP TABLE IF EXISTS tonal;
CREATE TABLE tonal (
	type varchar(24) REFERENCES noun_verb(type),
	tonalPattern varchar(128),
	PRIMARY KEY (type, tonalPattern)
);
...
CREATE TABLE part_of_speech(
    partOfSpeech varchar(24) REFERENCES noun_verb(type),
