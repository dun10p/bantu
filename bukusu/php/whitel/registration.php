...
<body>
	<div align = "center">
		<div id = "login">
			<p>Please Register
			<form action = "/~cs3380s15grp15/php/whitel/registration.php" method='post'>
...
//if the user did not access the secure site, redirect them to the https
	if(!isset($_SERVER['HTTPS'])){
		header('Location: https://babbage.cs.missouri.edu/~cs3380s15grp15/php/whitel/registration.php');
		exit;
	}
