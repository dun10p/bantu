...
$query = "SELECT a.root as Root, b.wordform as Word, b.tonalPattern as Tone,b.gloss as WordDef, b.wordID as Wordid, c.phraseform as Phrase, c.definition as PhraseDef, d.url FROM gp.root AS a 
        ...
        LEFT OUTER JOIN gp.phrasal_data AS c ON (
            ...
            b.wordid = c.verb2 OR 
            b.wordid = c.verb3) 
		INNER JOIN gp.audio AS d ON b.audioid = d.audioid ";        
